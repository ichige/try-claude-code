...
export const columns: QTableProps['columns'] = [
  ...
  { name: 'paymentRate', label: t('containers.fields.paymentRate'), field: 'paymentRate', align: 'right' },
  ...
  { name: 'website', label: t('containers.fields.website'), field: 'website', align: 'left' },
