...
export const schema = z.object({
  ...
  paymentRate:   z.coerce.number({ error: t('validation.numeric', { field: f('paymentRate') }) })
                   .int(t('validation.integer'))
                   .min(50, t('validation.minValue', { min: 50 }))
                   .max(100, t('validation.maxValue', { max: 100 })),
      ...
      fields: [
        ...
        },
        {
          ...
          component: () => h(QInput, {
            ...
            min: '50', max: '100', rules: [zodRule(schema.shape['paymentRate'] as z.ZodType)],
